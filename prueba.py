...
#Conexion a couchDb
URL = 'http://Eddy:elieddy2203z@localhost:5984'
...
#Conexion a mongodb
#CLIENT = MongoClient("mongodb+srv://Videogames:videogames@cluster0.60gzs.mongodb.net/Twiter?retryWrites=true&w=majority") #Indicarparametrosdel servidor
